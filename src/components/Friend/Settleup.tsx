  ...
  return (
    <Drawer>
      <DrawerTrigger
        ...
        className="flex items-center gap-2 rounded-md border bg-cyan-500 px-3 py-0 text-sm text-black focus:bg-cyan-600 focus:ring-0 focus-visible:outline-none "
      >
        <p className="font-normal">Settle up</p>
      </DrawerTrigger>
