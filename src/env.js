...
export const env = createEnv({
  ...
  server: {
    ...
    DATE_FORMAT_VARIANT_1: z.string().optional(),
    DATE_FORMAT_VARIANT_2: z.string().optional(),
    DATE_FORMAT_VARIANT_3: z.string().optional(),
    DATE_FORMAT_VARIANT_4: z.string().optional(),
    DATE_FORMAT_VARIANT_5: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    DATE_FORMAT_VARIANT_1: process.env.DATE_FORMAT_VARIANT_1,
    DATE_FORMAT_VARIANT_2: process.env.DATE_FORMAT_VARIANT_2,
    DATE_FORMAT_VARIANT_3: process.env.DATE_FORMAT_VARIANT_3,
    DATE_FORMAT_VARIANT_4: process.env.DATE_FORMAT_VARIANT_4,
    DATE_FORMAT_VARIANT_5: process.env.DATE_FORMAT_VARIANT_5,
