                  ...
                  <>
                    ...
                    >
                      <AlertDialogTrigger asChild>
                        ...
                        >
                          <Trash2 className="mr-2 h-4 w-4" /> {t('delete_group_short')}
                        </Button>
                      </AlertDialogTrigger>
                      <AlertDialogContent className="max-w-xs rounded-lg">
                        <AlertDialogHeader>
                          <AlertDialogTitle>
                            {canDelete ? t('delete_group_alert_title') : ''}
                          </AlertDialogTitle>
                          <AlertDialogDescription>
                            {canDelete
                              ? t('delete_group_alert_text')
                              : t('delete_group_alert_text_error')}
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                  ...
                  <>
                    ...
                    >
                      <AlertDialogTrigger asChild>
                        ...
                        >
                          <DoorOpen className="mr-2 h-5 w-5" /> {t('group_leave')}
                        </Button>
                      </AlertDialogTrigger>
                      <AlertDialogContent className="max-w-xs rounded-lg">
                        <AlertDialogHeader>
                          <AlertDialogTitle>
                            {canLeave ? t('leave_group_alert_title') : ''}
                          </AlertDialogTitle>
                          <AlertDialogDescription>
                            {canLeave
                              ? t('leave_group_alert_text')
                              : t('leave_group_alert_text_error')}
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                          <AlertDialogCancel>{t('cancel')}</AlertDialogCancel>
